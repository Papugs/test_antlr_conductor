...
public class RustParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, T__48=49, BOOL=50, INT=51, FLOAT=52, STRING=53, 
		BUILTIN=54, IDENTIFIER=55, COMMENT=56, BLOCK_COMMENT=57, WS=58;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "BOOL", "INT", "FLOAT", "STRING", "BUILTIN", "IDENTIFIER", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71776400415633604L) != 0)) {
				{
				{
				setState(40);
				statement();
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71776400415129728L) != 0)) {
				{
				setState(105);
				expression(0);
				}
